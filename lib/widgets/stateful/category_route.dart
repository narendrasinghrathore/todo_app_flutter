...
import 'package:todo_app_flutter/widgets/stateless/backdrop.dart';
import 'package:todo_app_flutter/widgets/stateless/category.dart';
import 'package:todo_app_flutter/widgets/stateless/category_tile.dart';
...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  static const _icons = <String>[
    'lib/data/icons/length.png',
    'lib/data/icons/area.png',
    'lib/data/icons/volume.png',
    'lib/data/icons/mass.png',
    'lib/data/icons/time.png',
    'lib/data/icons/digital_storage.png',
    'lib/data/icons/power.png',
    'lib/data/icons/currency.png',
  ];
  ...
  Future<void> didChangeDependencies() async {
    ...
    // lib/data/data/regular_units.json
  ...
  Future<void> _retrieveLocalCategories() async {
    ...
    final json = DefaultAssetBundle
        .of(context)
        .loadString('lib/data/regular_units.json');
