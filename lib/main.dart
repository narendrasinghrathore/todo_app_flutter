  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        foregroundColor: Color.fromRGBO(255, 204, 0, 1),
...
class CutsomTextBanner extends StatelessWidget {
  const CutsomTextBanner({
    Key key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Text(
      ...
      style: TextStyle(
        fontFamily: 'DidactGothic_Regular',
        fontSize: 22.0,
      ),
